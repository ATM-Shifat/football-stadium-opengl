...
void drawCube(unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 als = glm::mat4(1.0f), float r = 1.0f, float g = 1.0f, float b = 1.0f)
{
    lightingShader.use();
    ...
    lightingShader.setMat4("model", als);
